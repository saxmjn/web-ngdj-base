...
from app.settings import FIREBASE_PROJECT_ID, firebase_ins, firebase_cred, get_path, get_from_environment


def get_users():
    firebase_admin.initialize_app(firebase_cred, {'projectId': FIREBASE_PROJECT_ID })
    db = firestore.client()
