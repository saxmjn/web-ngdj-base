...
ERROR_CONFIG = {
    ...
    'ERR-USER-ACCESS-DENIED': ("User Access Denied", "Error Message"),
    'ERR-USER-ALREADY-EXISTS': ("User Already Exists", "Error Message"),
    'ERR-USER-OTHER-WITH-PHONE': ("User Already Exists with Phone Number", "Error Message"),
    'ERR-USER-YOU-WITH-PHONE': ("You already has this Phone Number", "Error Message"),
    ...
    'ERR-USER-OTHER-WITH-USERNAME': ("User Already Exists with username", "Error Message"),
    'ERR-USER-YOU-WITH-USERNAME': ("Your already has this username", "Error Message"),
